...
export class BoardService {
    ...
    private witClient:WitClient.WorkItemTrackingHttpClient4_1;
    private coreClient:CoreClient.CoreHttpClient4_1;
    private workClient:WorkClient.WorkHttpClient4_1;
